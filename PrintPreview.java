...
public class PrintPreview extends JFrame 
{
  ...
  public PrintPreview(Printable target) {
    this(target, "Print Preview", null);
  }

  public PrintPreview(Printable target, PageFormat f) {
    this(target, "Print Preview", f);
  }

  public PrintPreview(Printable target, String title, PageFormat f) {
    super(title);
    setSize(600, 400);
    m_target = target;
    pf = f;
    ...
    m_wPage = (int)(pf.getWidth());
    m_hPage = (int)(pf.getHeight());
    int scale = 10;
    int w = (int)(m_wPage*scale/100);
    int h = (int)(m_hPage*scale/100);
    ...
    try {
      while (true) {
        ...
        if (target.print(g, pf, pageIndex) != Printable.PAGE_EXISTS)
          break;
